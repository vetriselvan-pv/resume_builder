...
import { JobInputSection } from '../features/JobInputSection';
import { AtsScoreCard } from '../features/AtsScoreCard';
import { LaTeXEditor } from '../features/LaTeXEditor';
import { OptionalOutputsSection } from '../features/OptionalOutputsSection';
import { Toast } from '../components/ui/Toast';
import { ExportModal } from '../components/ui/ExportModal';
import { VETRISELVAN_PROFILE } from '../data/defaultProfile';
import { Profile, GeneratedPackage } from '../types';
import { generateCareerPackage } from '../services/api';
...
export default function Home() {
  ...
  const generatePackage = async (company: string, position: string, jobDescription: string) => {
    setIsLoading(true);
    try {
      const data = await generateCareerPackage(profile, company, position, jobDescription);
