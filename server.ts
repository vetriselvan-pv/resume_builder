...
// Fallback generator when Gemini key is absent or fails
function generateFallbackPackage(profile: any, company: string, position: string, jdText: string) {
...
// API endpoint to generate career package with Gemini
app.post("/api/generate-career-package", async (req, res) => {
  try {
